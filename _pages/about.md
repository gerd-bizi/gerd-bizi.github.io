...
I'm a Master's student in the Department of [Medical Biophysics](https://medbio.utoronto.ca) at the University of Toronto where I am supervised by [Dr. Chris McIntosh](https://mcintoshml.github.io). My research will focus on developing multimodal methods to enhance clinical decision-making.

I completed my undergraduate degree at U of T, where I studied [Computer Science](https://web.cs.toronto.edu) (with a [Focus in AI](https://artsci.calendar.utoronto.ca/program/asfoc1689b)) and [Biochemistry](https://biochemistry.utoronto.ca). I've taken advanced coursework in deep learning, computer vision, statistical learning, structural biology, bioinformatics, computational biology, and more.

A large research interest of mine during my undergraduate degree was the **cryo-em problem**. My senior thesis aimed to develop methodology to reconstruct membrane proteins embedded in their native lipid bilayer by using prior knowledge about their relative orientation. I was co-supervised by [Dr. John L. Rubinstein](https://www.rubinsteinlab.org) at SickKids and [Dr. David J. Fleet](https://www.cs.toronto.edu/~fleet/) at the Vector Institute.

Previously, I was a Research Assistant at [Sunnybrook Research Institute](https://research.sunnybrook.ca/), where I developed models to predict bladder cancer recurrence from whole-slide images under [Dr. Anne Martel](https://research.sunnybrook.ca/researchers/anne-martel/)and the [Biomarker Imaging Research Laboratory](https://research.sunnybrook.ca/facilities-and-research-groups/biomarker-imaging-research-laboratory/).
...
My hobbies include reading, playing [basketball](https://www.gerdbizi.com/basketball), running, trying coffee shops around Toronto, and playing the official format of the Pokémon videogame, [VGC](https://play.pokemonshowdown.com).